...
public class FileVO {
	...
	public String toString() {
		return "FileVO [file_num=" + file_num + ", original_name=" + original_name + ", real_path=" + real_path
				+ ", bookb_num=" + bookb_num + ", bb_code=" + bb_code + "]";
	}

	public FileVO(int file_num, String original_name, String real_path, int bookb_num, String bb_code) {
		super();
		this.file_num = file_num;
		this.original_name = original_name;
		this.real_path = real_path;
